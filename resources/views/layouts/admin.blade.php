...
@section('sidebar-nav')
    ...
    <a href="{{ route('admin.carreras.index') }}"
       class="sidebar-link {{ request()->routeIs('admin.carreras.*') ? 'active' : '' }}">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="{{ route('admin.periodos.index') }}"
       class="sidebar-link {{ request()->routeIs('admin.periodos.*') ? 'active' : '' }}">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="{{ route('admin.bitacora') }}"
       class="sidebar-link {{ request()->routeIs('admin.bitacora') ? 'active' : '' }}">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
