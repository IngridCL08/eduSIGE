...
<div class="alumno-info">
  <table>
    <tr>
      <td class="label">Matrícula</td><td><?php echo e($alumno->matricula); ?></td>
      <td class="label">Nombre</td><td colspan="3"><?php echo e($alumno->nombre_completo); ?></td>
    </tr>
    <tr>
      <td class="label">Carrera</td><td colspan="2"><?php echo e($alumno->carrera->nombre ?? '—'); ?></td>
      <td class="label">Semestre actual</td><td><?php echo e($alumno->semestre_actual); ?>°</td>
    </tr>
    <tr>
      <td class="label">CURP</td><td><?php echo e($alumno->aspirante->curp ?? '—'); ?></td>
      <td class="label">Fecha ingreso</td><td><?php echo e($alumno->periodoIngreso?->nombre ?? '—'); ?></td>
    </tr>
    <tr>
      <td class="label">Promedio gral.</td>
      <td><strong><?php echo e($alumno->promedio_general ? number_format($alumno->promedio_general, 2) : 'En proceso'); ?></strong></td>
      <td class="label">Créditos acum.</td>
      <td><?php echo e($creditosAprobados); ?></td>
    </tr>
  </table>
</div>

<?php $__empty_1 = true; $__currentLoopData = $historial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periodoId => $materiasPeriodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
  <?php $per = $periodos[$periodoId] ?? null; ?>
  <div class="periodo-section">
    <div class="periodo-label">
      <?php echo e($per ? $per->nombre : "Período #{$periodoId}"); ?>
    ...
    <table class="materias">
      ...
      <tbody>
        <?php $__currentLoopData = $materiasPeriodo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          <td><?php echo e($h->clave_materia ?? '—'); ?></td>
          <td><?php echo e($h->materia); ?></td>
          <td class="cal"><?php echo e($h->creditos); ?></td>
          <td class="cal <?php echo e($h->status); ?>">
            <?php echo e($h->calificacion !== null ? number_format($h->calificacion, 1) : '—'); ?>

          </td>
          <td><?php echo e($h->status_nombre); ?></td>
        </tr>
...
<div class="resumen">
  <table>
    <tr>
      ...
      <td class="valor"><?php echo e($creditosAprobados); ?></td>
      <td class="label">Promedio general:</td>
      <td class="valor"><?php echo e($alumno->promedio_general ? number_format($alumno->promedio_general, 2) : '—'); ?></td>
    </tr>
  </table>
</div>
...
<?php /**PATH C:\Users\HP\Documents\GitHub\eduSIGE\resources\views/escolar/constancias/pdf/kardex.blade.php ENDPATH**/ ?>