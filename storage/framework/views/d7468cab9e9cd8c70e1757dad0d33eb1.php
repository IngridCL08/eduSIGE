...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Portal Aspirante'); ?> — <?php echo e(config('app.name')); ?></title>
...
<nav class="bg-indigo-700 text-white shadow-md">
    <div class="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <?php if(auth()->guard('aspirante')->check()): ?>
        <div class="flex items-center gap-4 text-sm">
            <span class="text-indigo-200 hidden sm:block"><?php echo e(auth('aspirante')->user()->nombre_completo); ?></span>
            <form method="POST" action="<?php echo e(route('portal.aspirante.logout')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\HP\Documents\GitHub\eduSIGE\resources\views/layouts/portal-aspirante.blade.php ENDPATH**/ ?>