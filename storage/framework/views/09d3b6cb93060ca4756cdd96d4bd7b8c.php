<?php $__env->startSection('title','Nuevo Aspirante'); ?>
...
<div class="max-w-4xl">
<form method="POST" action="<?php echo e(route('escolar.aspirantes.store')); ?>" class="space-y-5">
    <?php echo csrf_field(); ?>
    ...
    <div class="card">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
                ...
                <input name="nombre" value="<?php echo e(old('nombre')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input name="apellido_paterno" value="<?php echo e(old('apellido_paterno')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input name="apellido_materno" value="<?php echo e(old('apellido_materno')); ?>"
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <option value="O" <?php echo e(old('sexo') === 'O' ? 'selected' : ''); ?>>Otro / Prefiero no decir</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input name="curp" value="<?php echo e(old('curp')); ?>" maxlength="18"
...
unset($__errorArgs, $__bag); ?>" placeholder="10 dígitos">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="sm:col-span-2">
                ...
                <input name="direccion" value="<?php echo e(old('direccion')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input name="colonia" value="<?php echo e(old('colonia')); ?>" class="form-input">
            </div>
            <div>
                <label class="form-label">Municipio / Ciudad</label>
                <input name="municipio" value="<?php echo e(old('municipio')); ?>" class="form-input">
            </div>
            <div>
                <label class="form-label">Estado</label>
                <input name="estado" value="<?php echo e(old('estado')); ?>" class="form-input">
            </div>
            <div>
                <label class="form-label">Código Postal</label>
                <input name="cp" value="<?php echo e(old('cp')); ?>" class="form-input" placeholder="00000" maxlength="10">
            </div>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input name="bachillerato" value="<?php echo e(old('bachillerato')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" max="10" name="promedio_bachillerato"
                       value="<?php echo e(old('promedio_bachillerato')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="anio_egreso" value="<?php echo e(old('anio_egreso')); ?>"
                       class="form-input" placeholder="<?php echo e(date('Y')); ?>" min="1980" max="<?php echo e(date('Y')); ?>">
            </div>
        </div>
    </div>

    <div class="flex justify-end gap-3">
        <a href="<?php echo e(route('escolar.aspirantes.index')); ?>" class="btn-secondary">Cancelar</a>
...
<?php echo $__env->make('layouts.escolar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\GitHub\eduSIGE\resources\views/escolar/aspirantes/create.blade.php ENDPATH**/ ?>