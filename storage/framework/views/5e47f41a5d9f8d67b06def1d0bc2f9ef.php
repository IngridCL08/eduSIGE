<?php $__env->startSection('title', 'Mi Examen'); ?>

<?php $__env->startSection('content'); ?>

<h2 class="text-xl font-bold text-slate-800 mb-6">Examen de Admisión</h2>

<?php $examen = $aspirante->examenesAdmision->first(); ?>
...
<div class="bg-white rounded-xl border border-slate-200 p-6 mb-5">
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-6">
        <div>
            ...
            <p class="font-semibold text-slate-800"><?php echo e($examen->fecha_examen->format('d/m/Y')); ?></p>
        </div>
        <div>
            <p class="text-xs text-slate-400 mb-1">Calificación</p>
            <p class="text-2xl font-bold text-slate-800">
                <?php echo e($examen->calificacion !== null ? number_format($examen->calificacion, 1) : '—'); ?>
        ...
        <div>
            ...
            <?php if($examen->resultado): ?>
                <span class="badge <?php echo e($examen->resultado_color); ?> text-sm px-3 py-1">
                    <?php echo e($examen->resultado_nombre); ?>
        ...
        <div>
            ...
            <p class="text-sm text-slate-600"><?php echo e($examen->aplicadoPor?->name ?? '—'); ?></p>
        </div>
    </div>

    <?php if($examen->observaciones): ?>
    <div class="mt-4 p-3 bg-slate-50 rounded-lg text-sm text-slate-600">
        <span class="font-medium">Observaciones:</span> <?php echo e($examen->observaciones); ?>

    </div>
    <?php endif; ?>
</div>

<?php if($examen->resultado === 'aprobado'): ?>
...
<?php elseif($examen->resultado === 'reprobado'): ?>
...
<?php elseif($examen->resultado === 'lista_espera'): ?>
...
<?php echo $__env->make('layouts.portal-aspirante', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\GitHub\eduSIGE\resources\views/portal/aspirante/examen.blade.php ENDPATH**/ ?>