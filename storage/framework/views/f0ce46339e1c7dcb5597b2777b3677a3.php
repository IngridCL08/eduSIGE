<?php $__env->startSection('title', 'Dashboard Escolar'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form method="GET" class="flex items-center gap-3 mb-6">
        <select name="periodo_id" class="form-select w-52" onchange="this.form.submit()">
            ...
            <?php $__currentLoopData = $periodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($p->id); ?>" <?php echo e($periodoId == $p->id ? 'selected' : ''); ?>><?php echo e($p->nombre); ?></option>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="stat-card">
            ...
            <div>
                <p class="stat-card-value"><?php echo e(number_format($resumen['total_aspirantes'])); ?></p>
        ...
        <div class="stat-card">
            ...
            <div>
                <p class="stat-card-value text-green-700"><?php echo e(number_format($resumen['admitidos'])); ?></p>
        ...
        <div class="stat-card">
            ...
            <div>
                <p class="stat-card-value text-blue-700"><?php echo e(number_format($resumen['total_alumnos'])); ?></p>
        ...
        <div class="stat-card">
            ...
            <div>
                <p class="stat-card-value text-emerald-700"><?php echo e(number_format($resumen['alumnos_activos'])); ?></p>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="card xl:col-span-2">
            <div class="card-header">
                ...
                <a href="<?php echo e(route('escolar.estadisticas.aspirantes', ['periodo_id' => $periodoId])); ?>"
        ...
        <div class="card xl:col-span-3">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <a href="<?php echo e(route('escolar.aspirantes.create')); ?>"
                ...
                <a href="<?php echo e(route('escolar.aspirantes.exportar', ['periodo_id' => $periodoId])); ?>"
                ...
                <a href="<?php echo e(route('escolar.alumnos.index')); ?>"
                ...
                <a href="<?php echo e(route('escolar.estadisticas.aspirantes')); ?>"
...
document.addEventListener('DOMContentLoaded', () => {
    const carreraData = <?php echo json_encode($porCarrera, 15, 512) ?>;
    const sexoData    = <?php echo json_encode($porSexo, 15, 512) ?>;
...
<?php echo $__env->make('layouts.escolar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\GitHub\eduSIGE\resources\views/escolar/dashboard.blade.php ENDPATH**/ ?>