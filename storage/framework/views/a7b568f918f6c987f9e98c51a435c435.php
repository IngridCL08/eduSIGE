...
<head>
    ...
    <title>Acceso Aspirantes — <?php echo e(config('app.name')); ?></title>
...
<div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8">
        ...
        <form method="POST" action="<?php echo e(route('portal.aspirante.login.post')); ?>" class="space-y-5">
            <?php echo csrf_field(); ?>

            <div>
                <label class="form-label">Folio o correo electrónico</label>
                <input type="text" name="credencial" value="<?php echo e(old('credencial')); ?>"
                       class="form-input <?php $__errorArgs = ['credencial'];
...
unset($__errorArgs, $__bag); ?>
    ...
    <p class="text-center text-sm text-slate-500 mt-4">
        ...
        <a href="<?php echo e(route('portal.aspirante.registro')); ?>" class="text-indigo-600 hover:underline font-medium">
            Regístrate aquí
        </a>
    </p>
</div>
...
<?php /**PATH C:\Users\HP\Documents\GitHub\eduSIGE\resources\views/portal/aspirante/login.blade.php ENDPATH**/ ?>